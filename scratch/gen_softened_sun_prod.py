#!/usr/bin/env python3
"""
Production generation of the refined space scene:
- Softened, elegant Sun with balanced golden corona (strength = 2.2, exp = 65.0).
- Earth with clean, smooth oceanic/slate terrain, 360-degree electric blue atmosphere, and glowing night-side city lights.
- Transiting moon and companion moon with realistic celestial lighting.
- Deep, pristine velvet cosmic blackness with microscopic diamond stars.
"""
...
""")
    ...
    materials = [
        ...
        # --- Earth Materials (Smooth Oceanic Slate Body, Clean & Realistic) ---
