...
""")
    ...
    # Balanced, elegant solar radiation - well calibrated between subtle and overpowering
    # strength 1.5, exponent 130.0 for a rich golden corona that preserves deep space
    lines.append(f"""sky {{
...
""")
    ...
    materials = [
        # Sun core - seamlessly blended incandescent radiance
