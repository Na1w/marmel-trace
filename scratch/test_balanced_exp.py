...
""")
    ...
    # Balanced corona size: exp 88.0 (between tight 160 and oversized 45), strength 1.15
    lines.append(f"""sky {{
  sun_dir            = {sun_dir[0]:.4f} {sun_dir[1]:.4f} {sun_dir[2]:.4f}
  sun_color          = 1.10 0.88 0.36
  sun_radius         = 0.0
  horizon_color      = 0.0 0.0 0.0
  zenith_color       = 0.0 0.0 0.0
  gradient_gamma     = 1.0
  sun_glow_exponent  = 88.0
  sun_glow_strength  = 1.15
  cloud_coverage     = 2.0
}}
""")

    materials = [
        # Sun core: warm incandescent star
        ("mat_sun_core", "pbr = 1\n  albedo = 0.1 0.1 0.1\n  emissive = 3.8 2.6 0.40\n  roughness = 0.5"),

        # Earth: Luminous oceanic/atmospheric blue, purely diffuse
        ("mat_earth_body", "pbr = 1\n  albedo = 0.28 0.60 0.95\n  roughness = 0.85\n  metallic = 0.0"),

        # Transiting Moon
        ("mat_moon", "pbr = 1\n  albedo = 0.36 0.34 0.32\n  roughness = 0.90\n  metallic = 0.02"),

        # Distant Companion Moon
