...
""")
    ...
    # Sun shifted a little bit to the right in the scene (from x=-4.8 to x=-5.5)
    sun_pos = (-5.5, 0.35, 11.5)
...
""")
  ...
  material = mat_sun_core
    ...
    # 2. Transiting Moon (shifted along with Sun to maintain transit eclipse)
    # Sun angular ratio: -5.5 / 21.5 = -0.2558
    # Moon angular ratio: -0.2558 - 0.0122 = -0.2680 -> moon_x = 13.8 * -0.2680 = -3.70
    moon_pos = (-3.70, 0.18, 3.8)
    moon_radius = 0.38
    prims.append(f"""sphere {{
