...
""")
    ...
    # Shifted further right: x = -6.2
    sun_pos = (-6.2, 0.35, 11.5)
    sun_dir = norm(sub(sun_pos, cam_eye))

    # Slightly higher solar glow/emission
    lines.append(f"""sky {{
...
""")
    ...
    materials = [
        # Elevated sun core emission
        ("mat_sun_core", "pbr = 1\n  albedo = 0.1 0.1 0.1\n  emissive = 3.8 2.6 0.45\n  roughness = 0.5"),
