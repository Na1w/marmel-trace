...
""")
    ...
    # Warm golden-white solar illumination and tight, elegant corona
    lines.append(f"""sky {{
  sun_dir            = {sun_dir[0]:.4f} {sun_dir[1]:.4f} {sun_dir[2]:.4f}
  sun_color          = 1.15 0.95 0.50
  sun_radius         = 0.0
  horizon_color      = 0.0 0.0 0.0
  zenith_color       = 0.0 0.0 0.0
  gradient_gamma     = 1.0
  sun_glow_exponent  = 220.0
  sun_glow_strength  = 1.05
  cloud_coverage     = 2.0
}}
""")

    materials = [
        # Sun core: brilliant incandescent golden star
        ("mat_sun_core", "pbr = 1\n  albedo = 0.1 0.1 0.1\n  emissive = 3.6 2.4 0.35\n  roughness = 0.5"),

        # Earth: Luminous oceanic/atmospheric blue, purely diffuse (NO billiard ball reflection)
