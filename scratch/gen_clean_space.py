...
"""
Refined space scene:
- Earth: Completely clean, smooth celestial sphere without any artificial orb/light points.
  Surrounded by the subtle transmissive atmosphere shell for an authentic daylight crescent.
- Stars: Subdued, natural astronomical pinpoints with gentle, realistic emission.
- Sun & Moon: Balanced golden sun with subtle, elegant corona and transiting moon silhouette.
"""
...
""")
    ...
    # Toned down, elegant corona: tight exponent (400.0), restrained strength (0.35)
    lines.append(f"""sky {{
...
""")
    ...
    # Materials
    materials = [
        # --- Sun: Rich golden star ---
        ("mat_sun_core", "pbr = 1\n  albedo = 0.1 0.1 0.1\n  emissive = 2.8 1.9 0.25\n  roughness = 0.5"),

        # --- Earth: Pure, clean planetary body ---
        ...
        # --- Realistic, subdued astronomical stars (gentle luminance, tiny sub-pixel) ---
  ...
  material = mat_distant_planet
    ...
    # 4. Earth - Clean, pure planetary sphere (NO artificial orbs or surface dots)
  ...
  material = mat_atmo_glass
    ...
    # 5. Realistic Subdued Astronomical Stars (distant, fine pinpoints)
    star_dist = 160.0
    for _ in range(350):
